define(['require',
  'jimu/BaseWidget',
  'jimu/loaderplugins/jquery-loader!jimu/tests/jquery/jquery-1.10.1'],
function(require, BaseWidget, $){
  ...
  //here, we should load template file sync. or you can use a amd text plugin to load the template file
